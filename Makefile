...
CLIENT_LDFLAGS = -lrt -lncurses
CLIENT_SRC = client.c
CLIENT_OBJ = $(CLIENT_SRC:.c=.o)

COMMON_SRC = util.c
COMMON_HEADERS = $(COMMON_SRC:.c=.h) rc.h
...
$(SERVER_TARGET): $(SERVER_OBJ) $(COMMON_OBJ)
	$(CC) $(CFLAGS) -o $(SERVER_TARGET) $(SERVER_LDFLAGS) $(SERVER_OBJ) $(COMMON_OBJ)

$(CLIENT_TARGET): $(CLIENT_OBJ) $(COMMON_OBJ)
	$(CC) $(CFLAGS) -o $(CLIENT_TARGET) $(CLIENT_LDFLAGS) $(CLIENT_OBJ) $(COMMON_OBJ)
